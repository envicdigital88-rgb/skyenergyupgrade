...
export function SubpageHero({ title, highlight, subtitle, image }: { title: string, highlight: string, subtitle: string, image: string }) {
  return (
    <section className="relative min-h-[50svh] md:min-h-[60svh] flex items-end pb-24 pt-40 overflow-hidden bg-[#051012]">
      <Image src={image} alt="Background" fill priority sizes="100vw" className="object-cover object-center scale-105" />
