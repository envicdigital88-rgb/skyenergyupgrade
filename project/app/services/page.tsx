      ...
      <section id="services" className="services-section section-pad">
        <div className="page-shell">
          <div className="section-intro-row">
            ...
            <p>Every property has a different energy story. We bring the right questions, practical advice and the right people to help you move forward.</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <ul className="space-y-4 text-gray-700">
                <li className="flex items-center gap-3"><Check size={18} className="text-lime-500" /> Comprehensive energy audits</li>
                <li className="flex items-center gap-3"><Check size={18} className="text-lime-500" /> Scalable solar arrays</li>
                <li className="flex items-center gap-3"><Check size={18} className="text-lime-500" /> Smart grid integration</li>
              </ul>
            </div>
